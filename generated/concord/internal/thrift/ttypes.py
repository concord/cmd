...
class ExecutorTaskInfoHelper:
  ...
  def __init__(self, frameworkLoggingLevel=thrift_spec[1][4], user=None, frameworkVModule=None, scheduler=None, proxy=None, client=None, traceAggregator=None, execName=None, folder=None, computationAliasName=None, clientArguments=None, environmentExtra=None,):
...
class PhysicalComputationMetdata:
  ...
  def write(self, oprot):
    ...
    if self.cpus is not None:
      oprot.writeFieldBegin('cpus', TType.I32, 3)
...
class BoltComputationRequest:
  ...
  def write(self, oprot):
    ...
    if self.instances is not None:
      ...
      oprot.writeFieldEnd()
    if self.cpus is not None:
      oprot.writeFieldBegin('cpus', TType.I64, 3)
      oprot.writeI64(self.cpus)
      oprot.writeFieldEnd()
    if self.mem is not None:
...
class Annotation:
  ...
  thrift_spec = (
    ...
    (5, TType.STRUCT, 'host', (Endpoint, Endpoint.thrift_spec), None, ), # 5
  )

  def __init__(self, timestamp=None, type=None, key=None, value=None, host=None,):
    self.timestamp = timestamp
    self.type = type
    self.key = key
    self.value = value
...
class Span:
  ...
  thrift_spec = (
    ...
    (5, TType.LIST, 'annotations', (TType.STRUCT,(Annotation, Annotation.thrift_spec)), None, ), # 5
  )

  def __init__(self, traceId=None, id=None, parentId=None, name=None, annotations=None,):
    self.traceId = traceId
    self.id = id
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i85 in xrange(_size81):
            _elem86 = Annotation()
            _elem86.read(iprot)
            self.annotations.append(_elem86)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.annotations is not None:
      ...
      for iter87 in self.annotations:
        iter87.write(oprot)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
...
class Trace:
  ...
  def __init__(self, id=None, spans=None,):
    self.id = id
    self.spans = spans
