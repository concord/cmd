...
class Client(Iface):
  ...
  def getTraceIds(self, startId):
    ...
    Parameters:
     - startId
    """
    self.send_getTraceIds(startId)
    return self.recv_getTraceIds()

  def send_getTraceIds(self, startId):
...
class Processor(Iface, TProcessor):
  ...
  def process_getTraceIds(self, seqid, iprot, oprot):
    ...
    result = getTraceIds_result()
    try:
      result.success = self._handler.getTraceIds(args.startId)
    except BoltError, e:
      result.e = e
...
class getTraceIds_args:
  ...
  def __init__(self, startId=thrift_spec[1][4],):
